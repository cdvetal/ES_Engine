...
def strotss_loss(out_tensor, style_tensor, content_weight=1.0 * 16.0,
                 extractor=None):  # out: tensor style: tensor [B,C,W,H] B=1
    ...
    for scale in scales:
        ...
        total_loss += scale_loss(result, content, style, scale, content_weight=content_weight, lr=lr,
                                 extractor=extractor)
